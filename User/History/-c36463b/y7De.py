...
class LatencyApi(ModelViewSet):
    ...
    serializer_class = WritePowerSysSerializer
    read_serializer_class = ReadPowerSysSerializer
    ...
    def get_serializer_class(self):
        ...
        return super(PowerSysApi, self).get_serializer_class()
    ...
    def create(self, request, *args, **kwargs):
        super(PowerSysApi, self).create(request, *args, **kwargs)
        return Response({'msg': "با موفقیت ساخته شد"}, status=status.HTTP_200_OK)

    def update(self, request, *args, **kwargs):
        super(PowerSysApi, self).update(request, *args, **kwargs)
